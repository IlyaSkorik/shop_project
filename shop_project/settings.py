...
# Email settings for checkout receipts.
# If SMTP credentials are provided, Django sends real emails.
# Otherwise it saves emails to files in sent_emails for lab checks.
